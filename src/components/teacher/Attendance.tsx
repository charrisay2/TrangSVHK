      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm">
        <div className="bg-white p-8 rounded-2xl shadow-xl max-w-sm w-full text-center relative">
          ...
          <div className="flex justify-center mb-6 bg-white p-4 border-2 border-slate-100 rounded-xl">
            <QRCodeSVG value={qrUrl} size={240} className="mx-auto" />
          </div>
    ...
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div>
        ...
        <p className="text-slate-500">
          Ghi nhận chuyên cần cho buổi học
        </p>
      </div>
      ...
      <div className="space-y-2">
        <label
          className={`text-xs font-bold uppercase ml-1 ${
            !isDateValid ? "text-red-500" : "text-slate-400"
          }`}
        >
          Ngày học
        </label>
        ...
        <div className="relative">
          <CalendarIcon
            className={`absolute left-3 top-1/2 -translate-y-1/2 ${
              !isDateValid ? "text-red-400" : "text-slate-400"
            }`}
            size={18}
          />
